...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('client_special_prices', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('from_state_id')->default(0); // جعل الولاية اختيارية
            $table->unsignedBigInteger('from_area_id')->nullable(); // جعل المنطقة اختيارية
            $table->unsignedBigInteger('to_country_id');
            $table->unsignedBigInteger('to_state_id')->default(0); // جعل الولاية اختيارية
            $table->unsignedBigInteger('to_area_id')->nullable(); // جعل المنطقة اختيارية
