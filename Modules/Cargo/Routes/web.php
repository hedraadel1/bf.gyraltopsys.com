        ...
        function () {
            ...
            Route::middleware('auth')->prefix(env('PREFIX_ADMIN', 'admin'))->group(function () {
                ...
                Route::prefix('shipments')->group(function () {
                     ...
                     Route::resource('custom-price-lists', 'CustomPriceListController');
                    Route::get('sh/pricelist', 'CustomPriceListController@index')->name('shipments.CustomPriceListController.index');
                ...
                Route::get('/state/create/{id}', 'StateController@create')->name('create.state');
                ...
                // New routes for special prices
                Route::get('shipments/settings/special-prices', 'SpecialPriceController@index')->name('special-prices.index');
                Route::resource('shipments/settings/special-prices', 'SpecialPriceController'); 
                Route::get('shipments/special-prices/configure',  'SpecialPriceController@configure')->name('special-prices.configure');

                // AJAX routes to fetch states and areas (you might want to keep these within the 'settings' group as well)
                Route::get('get-states/{countryId}', 'LocationController@getStates');
                Route::get('get-areas/{stateId}', 'LocationController@getAreas');
